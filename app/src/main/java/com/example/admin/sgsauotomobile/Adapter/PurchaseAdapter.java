package com.example.admin.sgsauotomobile.Adapter;
        ...
        import static com.example.admin.sgsauotomobile.ActivityClass.Activity_Purchas_Entry.tex_rowCount;
        import static com.example.admin.sgsauotomobile.ActivityClass.Activity_Purchas_Entry.txt_totalPur;
 ...
 */
    ...
    public class PurchaseAdapter extends ArrayAdapter<ListItem> {
        ...
        public PurchaseAdapter(Context context, int simple_list_item_1, List<ListItem> itemList){
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            Quantity = new ArrayList<Integer>();
                ...
                for(int j = 0; j< Quantity.size(); j++){
                    ...
                    txt_totalPur.setText("Total Quantity:"+test2+"");
                }
                        ...
                        alertDialogBuilder
                                ...
                                .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,int id) {
                                        ...
                                        txt_totalPur.setText("Total Quantity:");
